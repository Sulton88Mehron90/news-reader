...
//   const handleSearch = () => {
//     console.log('Search started for:', searchTerm, 'Category:', selectedCategory); // delete
//     setLoading(true);
...
//     searchAction
//       .then((data: any) => {
//         console.log('Articles fetched:', data.articles); // delete
...
//               </button>
//             </div>
//             {renderContent()} {/* This is where you invoke renderContent */}
//           </>
//         } />
